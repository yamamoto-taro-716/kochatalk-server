            ...
            <div class="col-md-3 col-sm-3 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <div class="form-group">
                            <label><?= __("性別") ?></label>
                            <p><?= $this->Form->multiCheckbox("gender", \App\Model\Entity\Account::getGenders(), ["hiddenField" => false]) ?></p>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label><?= __("登録日時") ?></label>
                            <p><?= $this->Form->control("birthday", ["label" => false, "class" => "form-control", "placeholder" => "From"]) ?></p>
                        </div>
                        <div class="form-group">
                            <label><?= __("Memo") ?></label>
